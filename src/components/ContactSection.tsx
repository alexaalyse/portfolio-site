  ...
  return (
    <section id="contact" className="relative overflow-hidden py-24 md:py-32 lg:pl-28">
      ...
      <div className="relative z-10 w-full max-w-[1440px] px-6 md:px-10 lg:pr-20">
        ...
        <div className="mt-16 grid border-t border-primary/20 md:grid-cols-2 lg:max-w-6xl">
          {contactItems.map((item) => {
            ...
            if (item.href) {
              return (
                <a
                  key={item.label}
                  href={item.href}
                  className="group border-b border-primary/20 py-8 pr-6 transition-colors hover:border-accent/70 md:px-8"
                >
                  {content}
                </a>
              )
            ...
            return (
              <div
                key={item.label}
                className="border-b border-primary/20 py-8 pr-6 md:px-8"
              >
                {content}
              </div>
            )
